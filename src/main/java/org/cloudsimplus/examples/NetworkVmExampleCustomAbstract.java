 ...
 */
abstract class NetworkVmExampleCustomAbstract {
     ...
     */
    NetworkVmExampleCustomAbstract() {
        ...
        final var dc = this.datacenter;
        final var list = dc.getHostList();
    ...
    protected final NetworkDatacenter createDatacenter() {
        ...
        VmAllocationPolicyMigrationBestFitStaticThreshold policy = new VmAllocationPolicyMigrationBestFitStaticThreshold(
        ...
        final var dc = new NetworkDatacenter(simulation, netHostList, policy);
    ...
    {
        final var task = new SendTask(sourceCloudlet.getTasks().size());
        task.setMemory(TASK_RAM);
    ...
    protected void addReceiveTask(final NetworkCloudlet targetCloudlet, final NetworkCloudlet sourceCloudlet) {
        final var task = new ReceiveTask(targetCloudlet.getTasks().size(), sourceCloudlet);
        task.setMemory(TASK_RAM);

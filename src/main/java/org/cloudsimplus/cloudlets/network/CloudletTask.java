...
@Getter @Setter
public abstract sealed class CloudletTask implements Identifiable permits CloudletExecutionTask, CloudletReceiveTask, CloudletSendTask, SendTask, ReceiveTask {
    /** The id of the task. */
    private long id;

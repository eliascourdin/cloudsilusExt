 ...
 */
public interface SwitchExt extends SimEntity{


    //SwitchExt NULL = new SwitchExtNull();
     ...
     */
    double downlinkTransferDelay(HostPacketExt packet, int simultaneousPackets);
     ...
     * @return the expected transmission time in seconds
     */
    double uplinkTransferDelay(HostPacketExt packet, int simultaneousPackets);

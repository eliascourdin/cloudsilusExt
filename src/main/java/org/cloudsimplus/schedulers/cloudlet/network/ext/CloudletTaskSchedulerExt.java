...
public interface CloudletTaskSchedulerExt {


    //CloudletTaskSchedulerExt NULL = new CloudletTaskSchedulerExtNull();
     ...
     */
    CloudletTaskSchedulerExt setVm(Vm vm);
     ...
     *
     */
    List<VmPacketExt> getVmPacketsToSend();
     ...
     */
    boolean addPacketToListOfPacketsSentFromVm(VmPacketExt pkt);
